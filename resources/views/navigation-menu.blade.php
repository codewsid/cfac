<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-0">
        <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-10">
                    @if (auth()->user()->role == 1)
                        ...
                        <x-nav-link href=""
                            :active="request()->routeIs('admin.feedbacks', 'admin.edit-feedbacks*', 'admin.office-replies')">
                        ...
                        <x-nav-link href=""
                            :active="request()->routeIs('admin.client-account', 'admin.office-account', 'admin.admin-account')">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" class="mr-2">
                                <path class="fill-current"
                                ...
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                        <div class="text-left text-black">
                                            <h1 class="font-semibold"> {{ Auth::user()->first_name }} {{ Auth::user()->last_name }} </h1>
