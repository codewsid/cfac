<x-guest-layout>
    <div class="h-screen grid place-content-center bg-kgreen/5">
        <div class="bg-white p-5 py-7 rounded-md w-[32rem]">
            <div class="text-center flex flex-col items-center">
                <div class="w-20 h-20">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="w-full h-full" viewBox="0 0 570 511.67482"
                        ...
                        <path
                            ...
                            transform="translate(-315 -194.16259)" fill="#009a3c" />
                        <path
                ...
                <h1 class="font-bold my-2 text-xl">Verify your email address</h1>
            </div>

            <h1 class="text-center">Please confirm that <span class="font-bold text-kgreen"> {{ auth()->user()->email }} </span> is your e-mail address by going to your email inbox.</h1>
            ...
            <div class="mt-5 flex flex-col items-center justify-between">
                <form method="POST" action="{{ route('verification.send') }}">
                    ...
                    <x-page-button type="submit" textValue="Resend Verification Email" class="bg-kgreen/90 hover:bg-kgreen text-white"/>
                </form>
